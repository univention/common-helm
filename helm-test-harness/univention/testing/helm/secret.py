...
class SecretPasswords(Annotations, Labels, Namespace):
    ...
    def test_auth_existing_secret_does_not_generate_a_secret(
        ...
        try:
            ...
            assert f"could not find template {self.template_file} in chart"
            return
        assert result == {}
    ...
    def test_global_secrets_keep_is_ignored(self, helm, chart_path):
        ...
        # Ensure secret is generated by not setting existingSecret
        ...
        # Merge global_values and local_values
